...
function unionToPayload(type, accessor) {
    switch (Payload[type]) {
        ...
        case 'CandidateTable': return accessor(new candidate_table_1.CandidateTable());
        case 'StringPayload': return accessor(new string_payload_1.StringPayload());
        case 'JoinPayload': return accessor(new join_payload_1.JoinPayload());
        case 'LatencyPayload': return accessor(new latency_payload_1.LatencyPayload());
        default: return null;
    }
}
...
function unionListToPayload(type, accessor, index) {
    switch (Payload[type]) {
        case 'NONE': return null;
        case 'CandidateTable': return accessor(index, new candidate_table_1.CandidateTable());
        case 'StringPayload': return accessor(index, new string_payload_1.StringPayload());
        case 'JoinPayload': return accessor(index, new join_payload_1.JoinPayload());
        case 'LatencyPayload': return accessor(index, new latency_payload_1.LatencyPayload());
        default: return null;
    }
}
